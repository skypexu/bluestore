...
public:
 /// using Transaction = ceph::os::Transaction;
   ...
   */
///  virtual objectstore_perf_stat_t get_cur_stats() = -1;
...
///   */
///  virtual ObjectMap::ObjectMapIterator get_omap_iterator( CollectionHandle &c,   ///< [in] collection const ghobject_t &oid  ///< [in] object
///    ) = 0;
  ...
  */
  ...
  // DEBUG
  virtual void inject_data_error(const ghobject_t &oid) {} virtual void inject_mdata_error(const ghobject_t &oid) {}
